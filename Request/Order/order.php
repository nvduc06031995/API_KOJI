...
class Order
{
    ...
    function getPartOrderList()
    {
        ...
        if ($this->dbConnect == NULL) {
            ...
            if (isset($_GET['SYOZOKU_CD']) && $_GET['SYOZOKU_CD'] != "") {
                ...
                FROM T_BUZAIHACYU 
                INNER JOIN T_BUZAIHACYUMSAI ON T_BUZAIHACYU.BUZAI_HACYU_ID=T_BUZAIHACYUMSAI.BUZAI_HACYU_ID
                INNER JOIN M_KBN ON T_BUZAIHACYU.HACYU_OKFLG = M_KBN.KBNMSAI_CD AND M_KBN.KBN_CD="08"
    ...
    function getMaterialOrderingList()
    {
        ...
        if ($this->dbConnect == NULL) {
            ...
            if ((isset($_GET['SYOZOKU_CD']) && $_GET['SYOZOKU_CD'] != "") &&
                ...
                INNER JOIN M_TANT ON T_BUZAIHACYUMSAI_SAVE.SAVE_TANT_CD=M_TANT.TANT_CD                
    ...
    function getCheckList()
    {
        ...
        if ($this->dbConnect == NULL) {
            ...
            if (isset($_GET['BUZAI_HACYU_ID']) && $_GET['BUZAI_HACYU_ID'] != "") {
                ...
                T_BUZAIHACYUMSAI.BUZAI_HACYUMSAI_ID            
                FROM T_BUZAIHACYU 
                INNER JOIN T_BUZAIHACYUMSAI ON T_BUZAIHACYUMSAI.BUZAI_HACYU_ID=T_BUZAIHACYU.BUZAI_HACYU_ID                
    ...
    function getPartList2()
    {
        ...
        if ($this->dbConnect == NULL) {
            ...
            if (
                ...
                T_ZAIKO.JISSU
                FROM M_BUZAI 
                INNER JOIN T_ZAIKO ON M_BUZAI.HINBAN=T_ZAIKO.HINBAN                
    ...
    function getInventoryListWithoutSaved()
    {
        ...
        if ($this->dbConnect == NULL) {
            ...
            if (isset($_GET['SYOZOKU_CD'])) {
                ...
                INNER JOIN M_BUZAI ON T_TANAMSAI.BUZAI_KANRI_NO = M_BUZAI.BUZAI_KANRI_NO
                INNER JOIN T_SYUKKOJISEKI ON T_TANA.SOKO_CD = T_SYUKKOJISEKI.SOKO_CD AND T_SYUKKOJISEKI.SYUKKO_DATE <= T_TANA.TANA_YMD AND T_TANAMSAI.JISYA_CD=T_SYUKKOJISEKI.JISYA_CD
                INNER JOIN T_BUZAIHACYU ON T_TANA.SYOZOKU_CD = T_BUZAIHACYU.SYOZOKU_CD AND T_BUZAIHACYU.HACYU_YMD <= T_TANA.TANA_YMD
                INNER JOIN T_BUZAIHACYUMSAI ON T_BUZAIHACYU.BUZAI_HACYU_ID = T_BUZAIHACYUMSAI.BUZAI_HACYU_ID AND T_BUZAIHACYUMSAI.JISYA_CD=T_TANAMSAI.JISYA_CD
        ...
        if ($this->dbConnect == NULL) {
            ...
            if (
                ...
                if ($SYOZOKU_CD != "") {
                    ...
                    FROM M_BUZAI 
                    INNER JOIN T_ZAIKO ON M_BUZAI.BUZAI_BUNRUI=T_ZAIKO.BASYO_GYOSYA_SYBET_CD AND T_ZAIKO.SOKO_CD="' . $SYOZOKU_CD . '"
                    INNER JOIN T_SYUKKOJISEKI ON T_SYUKKOJISEKI.SOKO_CD=T_ZAIKO.SOKO_CD 
                        AND (T_SYUKKOJISEKI.SYUKKO_DATE BETWEEN "' . $FIRST_DATE_OF_MONTH . '" AND "' . $LAST_DATE_OF_MONTH . '")
                    INNER JOIN T_BUZAIHACYU ON T_SYUKKOJISEKI.SOKO_CD=T_ZAIKO.SOKO_CD 
    ...
    //             M_BUZAI.BUZAI_KANRI_NO
    //             FROM M_BUZAI 
    //             INNER JOIN T_SYUKKOJISEKI ON M_BUZAI.HINBAN=T_SYUKKOJISEKI.JISYA_CD 
    //             INNER JOIN T_BUZAIHACYU ON M_BUZAI.HINBAN=T_BUZAIHACYU.HINBAN 
    //             INNER JOIN T_BUZAIHACYUMSAI ON M_BUZAI.HINBAN=T_BUZAIHACYU.JISYA_CD 
